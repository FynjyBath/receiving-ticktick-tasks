...
Telegram-бот для добавления задач в TickTick. Каждое текстовое сообщение (кроме `/start`) превращается в задачу в указанном списке TickTick с дедлайном в 23:00 текущего дня и напоминанием ровно в момент дедлайна.
...
- добавляет напоминание на момент дедлайна.
